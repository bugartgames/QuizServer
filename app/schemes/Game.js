    ...
    this.GenerateQuestions = function(callback)
    {
        if (In.Document.topic != undefined)
        {
            ...
            }).toArray(function(err, allQuestionsByTopic)
            {
                ...
                // while questions number is less than 5 and less than all questions number
                while (questions.length < 5 && questions.length < allQuestionsByTopic.length)
                {
