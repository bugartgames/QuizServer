...
exports.Initialize = function(app)
{
    ...
    // function to check ADMIN_API_KEY for each request
    function checkAdminAPIKey(req, res)
    {
        if (req.body.apiKey != ADMIN_API_KEY)
        {
            // send an error if api key is not valid
            errorResponse(res, 1001);
